...
function TrackingNumber({ setShowSentModal, orderID }) {
    ...
    return (
        <div className="modal">
            <div className="flex flex-col items-center justify-center p-5 rounded-md bg-400 border border-300">
                <div>
                    <input
                        id="tracking_number"
                        type="text"
                ...
                <div className="flex flex-row items-center justify-center mt-2">
                    <button
                        ...
                        className=" mr-3 text-200 bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm w-full sm:w-auto px-1 py-0.5 text-center"
                    >
                        Create
                    </button>
                    <button
                        onClick={closeHandler}
                        className="text-200 bg-300 hover:bg-red-800 font-medium rounded-lg text-sm w-full sm:w-auto px-1 py-0.5 text-center"
                    >
                        Close
                    </button>
                </div>
