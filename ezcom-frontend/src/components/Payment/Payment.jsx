...
const CreditCardForm = () => {
  ...
  return (
    <div className="flex justify-center bg-300 w-[60%] p-10 rounded-lg ml-20 mt-10  ">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3 pl-4 justify-center ">
        ...
        <input
              ...
              maxLength="16"
              className="bg-100 p-2 rounded-md pl-4 text-back"
        ...
        <div className="flex gap-2 justify-between">
          ...
          <button className="flex min-w-[30%] justify-center bg-red-500 rounded-xl p-2  text-100 text-xl">
            CANCEL
            </button>
